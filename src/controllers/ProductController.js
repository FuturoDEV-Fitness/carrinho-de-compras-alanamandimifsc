...
class ProductController extends Database {
    async create(req, res) {
        const { name, amount, color, voltage, description, category_id, price } = req.body;
        ...
        try {
            ...
            const query = `INSERT INTO products (name, amount, color, voltage, description, category_id, price) VALUES ($1, $2, $3, $4, $5, $6, $7) returning *`;
